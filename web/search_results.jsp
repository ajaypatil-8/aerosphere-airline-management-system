...
<nav class="navbar">
    ...
    <div class="nav-links">
        ...
        <% } else { %>
            <a href="login.jsp" class="nav-link btn-primary">Sign In</a>
        <% } %>
    </div>
</nav>
...
<div class="page-wrapper">
    ...
    <% if (flights == null || flights.isEmpty()) { %>
        <div class="card card-pad" style="text-align:center;padding:60px 20px;">
            ...
            <a href="index.jsp#search" class="btn btn-blue">Try Another Search</a>
        </div>
    <% } else { %>
        ...
        <div class="card card-top-line" style="animation-delay:.05s;">
            <div style="padding:20px 24px;display:grid;grid-template-columns:1fr auto 1fr auto;align-items:center;gap:20px;">
                ...
                <div style="text-align:right;">
                    ...
                    <% if (userName == null) { %>
                        <a href="login.jsp" class="btn btn-blue btn-sm">Login to Book</a>
