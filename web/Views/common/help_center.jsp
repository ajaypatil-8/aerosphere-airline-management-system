...
.help-hero h1{font-family:'Fraunces',sans-serif;font-size:2.4rem;font-weight:800;margin-bottom:12px}
...
.help-search input{flex:1;padding:12px 18px;border-radius:var(--radius-sm);border:none;font-family:'Inter',sans-serif;font-size:.95rem;outline:none}
.help-search button{padding:12px 22px;background:#fff;color:var(--primary);border:none;border-radius:var(--radius-sm);font-weight:700;cursor:pointer;font-family:'Inter',sans-serif}
...
.help-cat-title{font-family:'Fraunces',sans-serif;font-weight:700;font-size:1rem;margin-bottom:6px}
.help-cat-desc{font-size:.82rem;color:var(--text-muted)}
.faq-section{margin-bottom:48px}
.faq-section-title{font-family:'Fraunces',sans-serif;font-size:1.2rem;font-weight:800;margin-bottom:20px;padding-bottom:12px;border-bottom:2px solid var(--border)}
...
.contact-cta h3{font-family:'Fraunces',sans-serif;font-size:1.3rem;font-weight:800;margin-bottom:8px}
...
<div class="help-wrap">
  ...
  <div class="help-cats fade-up">
    <a href="#booking" class="help-cat">
      <div class="help-cat-icon"><i class="ph-bold ph-ticket"></i></div>
    ...
    <a href="#payment" class="help-cat">
      <div class="help-cat-icon"><i class="ph-bold ph-credit-card"></i></div>
    ...
    <a href="#baggage" class="help-cat">
      <div class="help-cat-icon"><i class="ph-bold ph-suitcase"></i></div>
    ...
    <a href="#checkin" class="help-cat">
      <div class="help-cat-icon"><i class="ph-bold ph-check-circle"></i></div>
    ...
    <a href="#account" class="help-cat">
      <div class="help-cat-icon"><i class="ph-bold ph-user"></i></div>
    ...
    <a href="${pageContext.request.contextPath}/contact" class="help-cat">
      <div class="help-cat-icon"><i class="ph-bold ph-envelope-simple"></i></div>
  ...
  <div id="faqContainer">
    ...
    <div class="faq-section fade-up" id="booking">
      <div class="faq-section-title"><i class="ph-bold ph-airplane-tilt"></i> Booking & Tickets</div>
    ...
    <div class="faq-section fade-up" id="payment">
      <div class="faq-section-title"><i class="ph-bold ph-credit-card"></i> Payments & Refunds</div>
    ...
    <div class="faq-section fade-up" id="baggage">
      <div class="faq-section-title"><i class="ph-bold ph-suitcase"></i> Baggage</div>
    ...
    <div class="faq-section fade-up" id="checkin">
      <div class="faq-section-title"><i class="ph-bold ph-check-circle"></i> Check-in</div>
    ...
    <div class="faq-section fade-up" id="account">
      <div class="faq-section-title"><i class="ph-bold ph-user"></i> My Account</div>
