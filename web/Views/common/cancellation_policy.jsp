...
.policy-card-header h2{font-family:'Syne',sans-serif;font-size:1.1rem;font-weight:800}
...
.tier.green{border-color:#10B981;background:rgba(16,185,129,.06)}
.tier.yellow{border-color:#F59E0B;background:rgba(245,158,11,.06)}
.tier.red{border-color:#EF4444;background:rgba(239,68,68,.06)}
.tier-pct{font-family:'Syne',sans-serif;font-size:2rem;font-weight:800;margin-bottom:4px}
.tier.green .tier-pct{color:#059669}
.tier.yellow .tier-pct{color:#D97706}
.tier.red .tier-pct{color:#DC2626}
...
.notice{background:rgba(245,158,11,.08);border:1px solid rgba(245,158,11,.3);border-radius:var(--radius);padding:16px 20px;color:var(--text);font-size:.88rem;line-height:1.65;display:flex;gap:10px;align-items:flex-start;margin-top:20px}
...
<div class="policy-wrap">
  ...
  <div class="policy-card fade-up">
    ...
    <div class="policy-card-body">
      <ul class="policy-list">
        <li><span class="ic">✅</span><span>Cancellations can only be made through your online account under "My Bookings". Phone or email cancellations are not accepted.</span></li>
        <li><span class="ic">✅</span><span>Only bookings with <strong>PAID</strong> status are eligible for cancellation and refund. Bookings that are already cancelled or expired cannot be cancelled again.</span></li>
        <li><span class="ic">✅</span><span>The refund is always credited to the <strong>same payment method</strong> used for the original booking. No cash refunds are provided.</span></li>
        <li><span class="ic">✅</span><span>Flight cancellations by the airline (force majeure, technical issues, weather) will result in a <strong>100% refund</strong> regardless of timing.</span></li>
        <li><span class="ic">✅</span><span>Group bookings (5+ passengers) may have different cancellation terms. Please contact support for group booking queries.</span></li>
        <li><span class="ic">✅</span><span>AeroSphere reserves the right to modify this policy. Changes will be notified via email and posted on this page.</span></li>
      </ul>
    </div>
  </div>
  ...
  <div class="policy-card fade-up">
    ...
    <div class="policy-card-body">
      <ul class="policy-list">
        <li><span class="ic">📬</span><span><strong>Cancellation submitted:</strong> Immediate. Your booking status changes to CANCELLED and a refund request is created instantly.</span></li>
        <li><span class="ic">🔍</span><span><strong>Admin review:</strong> 1–2 business days. Our team reviews the refund request against the cancellation policy.</span></li>
        <li><span class="ic">✅</span><span><strong>Approval notification:</strong> You receive an email when the refund is approved or if there is any issue.</span></li>
        <li><span class="ic">💳</span><span><strong>Credit to account:</strong> 3–5 business days after approval for cards. UPI refunds may reflect within 1–2 business days.</span></li>
      </ul>
    </div>
  </div>
