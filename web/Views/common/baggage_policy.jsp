...
.class-header.economy{background:var(--primary-glow);border-bottom:2px solid var(--primary)}
.class-header.business{background:var(--warning-bg);border-bottom:2px solid var(--warning)}
.class-title{font-family:'Fraunces',sans-serif;font-weight:800;font-size:1.05rem}
...
.baggage-val{font-weight:700;font-size:.95rem;font-family:'Fraunces',sans-serif}
.section-title{font-family:'Fraunces',sans-serif;font-size:1.15rem;font-weight:800;margin-bottom:18px;display:flex;align-items:center;gap:8px}
...
.prohibited-item{display:flex;gap:9px;align-items:flex-start;padding:12px;background:var(--danger-bg);border:1px solid var(--danger-border);border-radius:var(--radius-sm);font-size:.82rem;color:var(--text)}
...
<div class="page-hero fade-up">
  <h1><i class="ph-bold ph-suitcase"></i> Baggage Policy</h1>
...
<div class="policy-wrap">
  ...
  <div class="policy-section fade-up">
    <div class="section-title"><i class="ph-bold ph-backpack"></i> Free Baggage Allowance</div>
    <div class="allowance-grid">
      <div class="class-card">
        <div class="class-header economy">
          <span style="font-size:1.3rem"><i class="ph-bold ph-armchair"></i></span>
          <div>
        ...
        <div class="class-body">
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-airplane-tilt"></i> Check-in Baggage</span><span class="baggage-val">15 kg</span></div>
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-briefcase"></i> Cabin Baggage</span><span class="baggage-val">7 kg</span></div>
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-baby"></i> Infant (under 2)</span><span class="baggage-val">10 kg check-in</span></div>
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-ruler"></i> Max Cabin Dimensions</span><span class="baggage-val">55×40×20 cm</span></div>
        </div>
      </div>
      <div class="class-card">
        <div class="class-header business">
          <span style="font-size:1.3rem"><i class="ph-bold ph-star"></i></span>
          <div>
        ...
        <div class="class-body">
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-airplane-tilt"></i> Check-in Baggage</span><span class="baggage-val">25 kg</span></div>
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-briefcase"></i> Cabin Baggage</span><span class="baggage-val">10 kg</span></div>
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-baby"></i> Infant (under 2)</span><span class="baggage-val">10 kg check-in</span></div>
          <div class="baggage-row"><span class="baggage-label"><i class="ph-bold ph-ruler"></i> Max Cabin Dimensions</span><span class="baggage-val">55×40×20 cm</span></div>
        </div>
      </div>
  ...
  <div class="policy-section fade-up">
    <div class="section-title"><i class="ph-bold ph-coins"></i> Excess Baggage Charges</div>
    <div style="background:var(--surface-0);border:1px solid var(--border);border-radius:var(--radius-lg);overflow:hidden">
      <table class="excess-table">
        ...
        <tbody>
          <tr><td>Up to free allowance</td><td style="color:var(--success);font-weight:700">Free</td><td style="color:var(--success);font-weight:700">Free</td><td>No charges</td></tr>
    ...
    <p style="color:var(--text-muted);font-size:.82rem;margin-top:12px"><i class="ph-bold ph-lightbulb"></i> Pre-book additional baggage by contacting support to receive a 10% discount on excess charges.</p>
  </div>

  <div class="policy-section fade-up">
    <div class="section-title"><i class="ph-bold ph-clipboard-text"></i> Cabin Baggage Rules</div>
    <div class="rule-grid">
      <div class="rule-card">
        <div class="rule-card-title"><i class="ph-bold ph-briefcase"></i> One Bag Per Person</div>
      ...
      <div class="rule-card">
        <div class="rule-card-title"><i class="ph-bold ph-drop"></i> Liquids Rule (100ml)</div>
      ...
      <div class="rule-card">
        <div class="rule-card-title"><i class="ph-bold ph-laptop"></i> Electronics</div>
      ...
      <div class="rule-card">
        <div class="rule-card-title"><i class="ph-bold ph-lock-simple"></i> Cabin Security</div>
  ...
  <div class="policy-section fade-up">
    <div class="section-title"><i class="ph-bold ph-prohibit"></i> Prohibited Items</div>
    ...
    <div class="prohibited-list">
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-prohibit"></i></span><span>Firearms, guns, and replica weapons (all baggage)</span></div>
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-prohibit"></i></span><span>Knives, scissors over 6cm, sharp objects (cabin only)</span></div>
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-prohibit"></i></span><span>Explosives, grenades, fireworks (all baggage)</span></div>
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-fire"></i></span><span>Flammable liquids — petrol, lighter fluid, paint (all)</span></div>
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-flask"></i></span><span>Corrosive substances — acids, bleach, mercury</span></div>
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-test-tube"></i></span><span>Radioactive, infectious, or toxic materials</span></div>
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-battery-charging"></i></span><span>Lithium batteries &gt;160Wh (all), spare batteries in check-in</span></div>
      <div class="prohibited-item"><span class="ic"><i class="ph-bold ph-plant"></i></span><span>Narcotics, controlled substances (all baggage)</span></div>
    </div>
    <p style="color:var(--text-muted);font-size:.82rem;margin-top:14px"><i class="ph-bold ph-warning"></i> Carrying prohibited items is a criminal offence. Violators will be handed over to the relevant authorities. AeroSphere assumes no liability for confiscated items.</p>
  </div>
