...
.pay-label{font-weight:700;font-size:.9rem}
    ...
    <div class="two-col">
        ...
        <div class="card" style="animation-delay:.15s">
            <div class="card-inner">
                ...
                <p class="pay-note">By completing payment you agree to AeroSphere's terms. Cancellations 24h+ before departure are eligible for a refund.</p>
            </div>
        </div>
    </div>
</div>
