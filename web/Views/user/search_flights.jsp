...
<div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;padding:16px 0 4px">
  ...
  <div style="display:flex;gap:4px;flex-wrap:wrap">
    <%if(_cp>1){%><a href="?source=<%=java.net.URLEncoder.encode(srcParam,"UTF-8")%>&amp;destination=<%=java.net.URLEncoder.encode(dstParam,"UTF-8")%>&amp;departDate=<%=java.net.URLEncoder.encode(datParam,"UTF-8")%>&amp;numSeats=<%=seatsParam%>&amp;page=1" style="<%=_ps()%>">«</a><%}%>
    <%if(_cp>1){%><a href="?source=<%=java.net.URLEncoder.encode(srcParam,"UTF-8")%>&amp;destination=<%=java.net.URLEncoder.encode(dstParam,"UTF-8")%>&amp;departDate=<%=java.net.URLEncoder.encode(datParam,"UTF-8")%>&amp;numSeats=<%=seatsParam%>&amp;page=<%=_cp-1%>" style="<%=_ps()%>">‹</a><%}%>
    <%for(int _pg=_s;_pg<=_e;_pg++){%><a href="?source=<%=java.net.URLEncoder.encode(srcParam,"UTF-8")%>&amp;destination=<%=java.net.URLEncoder.encode(dstParam,"UTF-8")%>&amp;departDate=<%=java.net.URLEncoder.encode(datParam,"UTF-8")%>&amp;numSeats=<%=seatsParam%>&amp;page=<%=_pg%>" style="<%=_ps(_pg==_cp)%>"><%=_pg%></a><%}%>
    <%if(_cp<_tp){%><a href="?source=<%=java.net.URLEncoder.encode(srcParam,"UTF-8")%>&amp;destination=<%=java.net.URLEncoder.encode(dstParam,"UTF-8")%>&amp;departDate=<%=java.net.URLEncoder.encode(datParam,"UTF-8")%>&amp;numSeats=<%=seatsParam%>&amp;page=<%=_cp+1%>" style="<%=_ps()%>">›</a><%}%>
    <%if(_cp<_tp){%><a href="?source=<%=java.net.URLEncoder.encode(srcParam,"UTF-8")%>&amp;destination=<%=java.net.URLEncoder.encode(dstParam,"UTF-8")%>&amp;departDate=<%=java.net.URLEncoder.encode(datParam,"UTF-8")%>&amp;numSeats=<%=seatsParam%>&amp;page=<%=_tp%>" style="<%=_ps()%>">»</a><%}%>
  </div>
</div>
<%}}%>
    <% } %>
