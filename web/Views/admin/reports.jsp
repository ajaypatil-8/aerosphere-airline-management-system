...
.report-title{font-family:'Fraunces',sans-serif;font-weight:700;font-size:.95rem;position:relative;z-index:1}
...
.topbar-title{font-family:'Fraunces',sans-serif;font-weight:800;font-size:1rem}
...
<div class="as-main">
  <div class="topbar">
    <span class="topbar-title"><i class="ph-bold ph-chart-bar"></i> Reports &amp; Analytics</span>
  ...
  <div class="page-wrap">
    ...
    <div class="reports-grid fu">
      <a href="${pageContext.request.contextPath}/reportBookings" class="report-card">
        <div class="report-icon"><i class="ph-bold ph-ticket"></i></div>
      ...
      <a href="${pageContext.request.contextPath}/reportFlights" class="report-card">
        <div class="report-icon"><i class="ph-bold ph-airplane-tilt"></i></div>
      ...
      <a href="${pageContext.request.contextPath}/reportPayments" class="report-card">
        <div class="report-icon"><i class="ph-bold ph-credit-card"></i></div>
      ...
      <a href="${pageContext.request.contextPath}/reportUsers" class="report-card">
        <div class="report-icon"><i class="ph-bold ph-users"></i></div>
      ...
      <a href="${pageContext.request.contextPath}/reportCancelled" class="report-card">
        <div class="report-icon"><i class="ph-bold ph-x-circle"></i></div>
      ...
      <a href="${pageContext.request.contextPath}/reportPassengers" class="report-card">
        <div class="report-icon"><i class="ph-bold ph-suitcase"></i></div>
