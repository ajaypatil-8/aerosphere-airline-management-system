...
<div class="page-wrapper">
  ...
  <div class="table-wrap animate-fadeup">
    ...
    <tr><td style="color:var(--text-muted)"><%= i %></td><td style="color:var(--primary);font-weight:700">#<%= b.id %></td>
    <td style="font-weight:500"><%= b.userName %></td><td><strong><%= b.flightNo %></strong></td>
    <td style="font-size:.84rem"><%= b.source %> → <%= b.destination %></td><td><%= b.seats %></td>
    ...
    <td style="font-size:.8rem;color:var(--text-muted)"><%= b.bookingDate!=null?b.bookingDate.toString().substring(0,10):"—" %></td></tr>
    <% } %></tbody></table>
    <% } %>
  </div>
</div>
