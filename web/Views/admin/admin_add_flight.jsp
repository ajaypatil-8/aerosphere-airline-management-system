...
.page-wrapper{max-width:720px;margin:0 auto;padding:32px 24px}
...
@media(max-width:600px){.form-grid{grid-template-columns:1fr}.page-wrapper{padding:20px 14px}.navbar{padding:10px 16px}.nav-links .nav-link:not(.btn-danger){display:none}}
</style>
</head>
<body>
    ...
    <form action="${pageContext.request.contextPath}/addFlight" method="post">
      <div class="form-grid">
        <div class="form-group">
          ...
          <div class="field-wrap"><span class="fi">🛩</span><input type="text" name="flight_no" placeholder="e.g. SK101" required maxlength="20"></div>
        </div>
        <div class="form-group">
          <label>Departure Date *</label>
          <div class="field-wrap"><span class="fi">📅</span><input type="date" name="depart_date" required></div>
        </div>
        <div class="form-group">
          <label>From (Source) *</label>
          <div class="field-wrap"><span class="fi">🛫</span><input type="text" name="source" placeholder="e.g. Mumbai" required maxlength="100"></div>
        </div>
        <div class="form-group">
          <label>To (Destination) *</label>
          <div class="field-wrap"><span class="fi">🛬</span><input type="text" name="destination" placeholder="e.g. Delhi" required maxlength="100"></div>
        </div>
        <div class="form-group">
          <label>Departure Time *</label>
          <div class="field-wrap"><span class="fi">🕐</span><input type="time" name="depart_time" required></div>
        </div>
        <div class="form-group">
          <label>Arrival Time</label>
          <div class="field-wrap"><span class="fi">🕑</span><input type="time" name="arrival_time"></div>
        </div>
        <div class="form-group">
          <label>Price per Seat (₹) *</label>
          <div class="field-wrap"><span class="fi">💰</span><input type="number" name="price" placeholder="e.g. 4500" min="1" step="0.01" required></div>
        </div>
        <div class="form-group">
          <label>Total Seats *</label>
          <div class="field-wrap"><span class="fi">💺</span><input type="number" name="seats_total" placeholder="e.g. 180" min="1" max="999" required></div>
        </div>
      </div>
